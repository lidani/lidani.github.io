<template>
  <h3>Privacy Policy for Tereh Juliana</h3>

  <div>
    <p>
      At Tereh Juliana, accessible from terehjuliana.com.br, one of our main
      priorities is the privacy of our visitors. This Privacy Policy document
      contains types of information that is collected and recorded by Tereh
      Juliana and how we use it.
    </p>
    ...
    <p>
      ...
      and/or collect in Tereh Juliana. This policy is not applicable to any
      information collected offline or via channels other than this website. Our
      Privacy Policy was created with the help of the TermsFeed Privacy Policy
      Generator.
    </p>
    ...
    <h5>Log Files</h5>
    <p>
      Tereh Juliana follows a standard procedure of using log files. These files
    ...
    <p>
      ...
      advertising partners of Tereh Juliana.
    </p>
    <p>
      Third-party ad servers or ad networks uses technologies like cookies,
      JavaScript, or Web Beacons that are used in their respective
      advertisements and links that appear on Tereh Juliana, which are sent
    ...
    <p>
      Note that Tereh Juliana has no access to or control over these cookies
      that are used by third-party advertisers.
    </p>

    <h5>Third Party Privacy Policies</h5>
    <p>
      Tereh Juliana's Privacy Policy does not apply to other advertisers or
    ...
    <p>
      Tereh Juliana does not knowingly collect any Personal Identifiable
